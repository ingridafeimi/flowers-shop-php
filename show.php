...
// marrim rekordin nga databaza me id qe morem nga url
$sql = "SELECT * FROM flowers WHERE id = $id";
$result = mysqli_query($database, $sql);

//funksion qe perdoret per te marr nje rekord te vetem nga databaza. ky rekord do te na duhet per te plotesuar fushat e formes se meposhtme dukeqenese jemi ne Edit.
...
<section id="page-title">
    <div class="container py-5 my-2">
        <h1 class="m-0"><?= $flower["title"] ?></h1>
        <p class="untitle m-0 pb-3">The amaryllis is a popular bulb plant with large lily-like blooms and long, thick
            stems belladonna.</p>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-0">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="flowers.php">Flowers</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <img src="<?= $flower["image"] ?>" class="w-100 img-thumbnail border-0">
            </div>
            <div class="col-sm-12 col-md-6">
                <h4 class="mb-3"><?= $flower["title"] ?></h4>
